...
class _DuaDetailScreenState extends State<DuaDetailScreen> {
  ...
  Future<void> _toggleFav(int index) async {
    ...
    final success = await DatabaseHelper.instance.toggleDuaFavorite(dua.reference, newFav);
    if (success && mounted) {
  ...
  void _share(Dua dua) {
    final text = '${widget.duaTitle}\n\n'
        '${dua.arabic ?? ''}\n\n'
        '${dua.translation ?? ''}\n\n'
        'Shared from Deen Azkar app';
    Share.share(text);
  }
      ...
      body: _loading
          ...
          : _duas.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    final dua = _duas[index];
                    final isCurrentPlaying = audioService.playingReference == dua.reference;
                    return _DuaDetailCard(
                      ...
                      isPlaying: isCurrentPlaying && audioService.isPlaying,
                      position: isCurrentPlaying ? audioService.position : Duration.zero,
                      duration: isCurrentPlaying ? audioService.duration : Duration.zero,
                      onPlayTap: () => _togglePlay(context, dua.reference),
                      onSeek: (pos) => isCurrentPlaying ? audioService.seekTo(pos) : null,
